  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to X-RayMedIxs - Your trusted partner in Medical Equipment Maintenance Support. Ensuring optimal operational performance and maximum equipment uptime tailored to meet your unique needs."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1516549655169-df83a0774514?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZWRpY2FsJTIwZXF1aXBtZW50fGVufDB8fHx8MTY5MTIyMzAwM3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to X-RayMedIxs - Your trusted partner in Medical Equipment Maintenance Support. Ensuring optimal operational performance and maximum equipment uptime tailored to meet your unique needs.`}
            </Text>
            <Box
